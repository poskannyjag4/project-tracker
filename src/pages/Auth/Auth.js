...
export function Auth(){
    ...
    //Google Setup
    const googleSetup = document.createElement('div');
    googleSetup.id = "g_id_onload";

    //add function to global window scope
    window.loginUser = loginUser;

    //google settings for GIS
    googleSetup.setAttribute('data-client_id', import.meta.env.VITE_GOOGLE_CLIENT_ID);
    googleSetup.dataset.callback = loginUser.name;
    googleSetup.dataset.auto_prompt = "true";
    googleSetup.dataset.itp_support = "true";
    ...
    leftSide.append(title, slogan, googleBtn, googleSetup);
